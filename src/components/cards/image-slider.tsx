...
const ImageSlider: React.FC<ImageSliderProps> = ({ urls }) => {
  ...
  const activeStyles =
    "active:scale-[0.97] grid opacity-100 hover:scale-105 absolute top-1/2 -translate-y-1/2 aspect-square h-8 w-8 z-50  place-items-center rounded-full border-2 bg-white bg-zinc-100";
