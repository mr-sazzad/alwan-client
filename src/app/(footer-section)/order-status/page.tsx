    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            At Alwan-ideal, we strive to make your shopping experience as smooth
            as possible. Here&apos;s how we process your order:
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ol className="list-decimal list-inside space-y-2">
            <li>Order Received: We confirm your order and begin processing.</li>
            <li>
              Order Preparation: Our team carefully prepares your items for
              shipment.
            </li>
            <li>
              Quality Check: We perform a final inspection to ensure everything
              is perfect.
            </li>
            <li>
      ...
      <Accordion type="single" collapsible className="mb-8">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            seasons or promotional periods, processing may take up to 3 business
            days.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger>Do you offer expedited shipping?</AccordionTrigger>
          <AccordionContent>
            Yes, we offer expedited shipping options at checkout. These options
            may vary depending on your location and the items in your order.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
