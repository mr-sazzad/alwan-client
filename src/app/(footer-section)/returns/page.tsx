    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-white p-6 rounded-lg shadow-md flex items-start">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2">Unused Products Only</h3>
            <p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex items-start">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2">7-Day Return Window</h3>
            <p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex items-start">
          ...
          <div>
            ...
            <p>
              ...
              cases of defective items. We recommend using a trackable shipping
              service.
            </p>
          </div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md flex items-start">
          ...
          <div>
            ...
            <p>
              ...
              your refund. Please allow 5-10 business days for the refund to
      ...
      <Accordion type="single" collapsible className="w-full mb-12">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            within 7 days of receiving your product. You can reach us via email
            at returns@example.com or call us at 1-800-123-4567. Please have
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            We do not accept returns on personalized items, intimate apparel, or
            clearance items. Additionally, any product that shows signs of use
            or has been altered in any way is not eligible for return.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            Once we receive your return, we&apos;ll inspect the item within 2-3
            business days. If approved, your refund will be processed, and a
